...
miprov <-prov[prov$PROV %in% '08', ]
st_write(obj = miprov, dsn = 'data/miproyectoexportado.gpkg', driver = 'GPKG')
miprovexportado<- st_read(dsn = 'data/miproyectoexportado.gpkg')
miprovexportado
```
